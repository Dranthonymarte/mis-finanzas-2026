...
// Requires: RESEND_API_KEY env var in CF Pages settings
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    if (!apiKey) {
      // Silently succeed if key not set (don't break the UX)
      return new Response(JSON.stringify({ ok: true, warn: 'no_key' }), {
